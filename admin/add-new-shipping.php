...
<head>
    ...
    <title>Add Localization- Furnterior</title>
        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-body">
                <div class="title-header">
                    <h5>Add New Localization Details</h5>
                </div>

                <!-- New Localization Add Start -->
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="form-label-title col-sm-2 mb-0">City
                                                            Name *</label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input name="charges" id="charges" class="form-control" type="number"
...
<?php
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = "INSERT INTO Shipping (City,Province,Delivery_Charges) VALUES('$name','$province','$charges')";
		if ($conn->query($sql) === TRUE) {
		    echo "<script>
              // After successful product insertion, show notification
              $('#notification').html('Shipping Added successfully!')
                .fadeIn('slow', function() {
                  $(this).delay(5000).fadeOut('slow');
              });
            </script>";
                echo "<script>console.log('Shipping added successfully'); window.location.href= 'shipping.php';</script>";
