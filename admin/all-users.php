...
<head>
    ...
    <title>Furnterior - All Users</title>
    <!-- Google font-->
    <link
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while($row = $result->fetch_assoc()) {
                                                            // Getting Image                                                          	
                                                          	$imageURL = $row["Image"];
                                                          	$target_dir= 'customer-profile/';
                                                          	$img= $target_dir.$imageURL;
                                                            echo "<tr>
                                                                 <td>
                                                                 <span> <img src='$img' alt='users'></span>
                                                                 </td>";
                                                                ...
                                                                // Getting Email
                                                                $email = $row["Email"];   
                                                                echo '<td> <a href="javascript:void(0)">  <span class="d-block ">'.$email.'</span></a></td>';
