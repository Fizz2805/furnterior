...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            $html_message = file_get_contents('email-templates/reset-password.html');
          	$link = "<button><a href='https://codemply.com/admin/reset-password.php?token=$token'>Reset Password</a></button>";
