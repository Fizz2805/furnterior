            ...
            <div class="header-wrapper row m-0">
                <div class="header-logo-wrapper col-auto p-0">
                    <div class="logo-wrapper">
                        <a href="/">
                            <img class="img-fluid main-logo" src="assets/images/logo.jpeg" alt="logo">
                            <img class="img-fluid white-logo" src="assets/images/logo.jpeg" alt="logo">
                        </a>
                    </div>
                ...
                <form class="form-inline search-full col" action="all-products" method="GET" style="visibility: hidden ">
                    <div class="form-group w-100">
                        <div class="Typeahead Typeahead--twitterUsers">
                            <div class="u-posRelative">
                                <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text"
                                    placeholder="Search .." name="search" title="" autofocus>
                      ...
                      <!--   <li class="onhover-dropdown">
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 me-0">
                            <div class="media profile-media">
                                <img class="user-profile rounded-circle" src="<?php echo $photo; ?>" alt="">
