...
<head>
    ...
    <meta name="description"
        content="This an admin login page for an acommerce website.">
    <meta name="keywords"
        content="Admin, ecommerce">
    <meta name="author" content="codemply">
    <link rel="icon" href="assets/images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="assets/images/favicon.png" type="image/x-icon">
    <title>Admin Log In- Furnterior</title>
            ...
            <div class="col-12 p-0">
                <div class="login-section">
                    <div class="materialContainer">
                        <div class="box">
                          <img src="assets/images/logo.jpeg" style="width: inherit; margin-bottom: 20px;" >
        ...
        if ($result->num_rows == 1) {
            ...
            if ($password === $userpassword) {
                // Password is correct
              	...
              	// Check if user has checked the Remember me box
                ...
                echo '<script> console.log("Login successful!"); window.location.href = "http://localhost/furnterior/admin"; </script>';
            } else {
