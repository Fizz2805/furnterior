...
<body class="theme-color2 light ltr">
                ...
                <div class="col-lg-12 col-12 ratio_30">
                    <div class="banner-deatils">
                        <div class="banner-image">
                            <img src="assets/images/banner/ar-banner.jpg" class="img-fluid bg-img blur-up lazyload"
                                alt="">
                            <div class="banner-content">
                                <div>
                                    <h3>View Products in Your <span style="font-weight: bold; color: #000">Space</span></h3>
                                    <p style="color: #000;">Shop the latest furniture while virtually placing it to your space </p>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  <!-- Product section -->
            ...
            <?php
            $sql = "SELECT * FROM Product where Category=5";
