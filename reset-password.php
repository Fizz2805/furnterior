<?php 
  session_start();
	$email= $_SESSION['forgot-user-email'];
...
<body class="signup-page theme-color2">
  ...
  position: relative; top: -25px; left: 90%; color: #E87316"></i>
              ...
              <div class="input">
                ...
                <p><a href="log-in" class="theme-color">Login Instead?</a></p>
            </div>
        </div>
    </div>
  ...
  <?php
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      // Check connection
		...
		// Retrieve user new password from the form
		$password = $_POST['pass']; 
		...
		if ($conn->query($sql) === TRUE) {
        	...
        	unset($_SESSION['forgot-user-email']);
      		echo "<meta http-equiv='refresh' content='3;url=log-in'>"; // 3 seconds delay
